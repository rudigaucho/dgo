...
{
  setTimeout("window.location='pesq_42.php'",3000);
...
<body>
 ...
 <span><strong>PESQUISA POR ESTAÇÃO</strong></span><br><br><br>
  ...
  <form class="form-inline" role="form"   method="POST" action="pesq_42.php" style="margin-left:10%;">
...
$sql = mysql_query ("select * from anuf where estacao = '$estacao' and anuf = '42' order by porta asc" );
// $sql2 = mysql_query ("select count(*) as conta  from relatorio where gra = '".$busca."' and data BETWEEN  '$data 00:00:00' and '$data 23:59:00' order by data desc   " );
    ...
    <div class="modal-dialog-lg">
      ...
      <div class="modal-content">
        ...
        <h4 class="modal-title" style="text-align:center">RELATÓRIO.<h4>
         <form role="form" id="form" name="seachform" method="post" action="pesq_42.php " >
  <div class="form-group" >
...
if($sql && $sql2 )
{
  ...
  echo '<meta HTTP-EQUIV="Refresh" CONTENT="3;URL=pesq_42.php?estacao='.$estacao.'">';
