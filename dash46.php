                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"> SJD </div>
                                       
                                    </div>
                                </div>
                            </div>
                            <a href="pesq_41.php?anuf=46&estacao=SJD">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"> DVZ </div>
                                       
                                    </div>
                                </div>
                            </div>
                            <a href="pesq_41.php?anuf=46&estacao=DVZ">
                                <div class="panel-footer">
                                    <span class="pull-left">Portas</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                      </a>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"> PBC </div>
                                       
                                    </div>
                                </div>
                            </div>
                            <a href="pesq_41.php?anuf=46&estacao=PBC">
                                <div class="panel-footer">
                                    <span class="pull-left">Portas</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                      </a>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"> FNB </div>
                                       
                                    </div>
                                </div>
                            </div>
                            <a href="pesq_41.php?anuf=46&estacao=FNB">
                                <div class="panel-footer">
                                    <span class="pull-left">Portas</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                      </a>
