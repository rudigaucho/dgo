...
<body>
 ...
 <span><strong>PESQUISA POR ESTAÇÃO</strong></span><br><br><br>
  ...
  <form class="form-inline" role="form"   method="POST" action="pesq_41.php" style="margin-left:10%;">
    ...
    <div class="modal-dialog" >
      ...
      <div class="modal-content">
        ...
        <h4 class="modal-title" style="text-align:center">RELATÓRIO.<h4>
         <form role="form" id="form" name="seachform" method="post" action="pesq_41.php " >
  <div class="form-group" >
...
if($sql && $sql2 )
{
  ...
  echo '<meta HTTP-EQUIV="Refresh" CONTENT="3;URL=pesq_41.php?estacao='.$estacao.'">';
