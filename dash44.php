                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"> UMR </div>
                                       
                                    </div>
                                </div>
                            </div>
                            <a href="pesq_41.php?anuf=44&estacao=UMR">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"> MGA </div>
                                       
                                    </div>
                                </div>
                            </div>
                            <a href="pesq_41.php?anuf=44&estacao=MGA">
                                <div class="panel-footer">
                                    <span class="pull-left">Portas</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                      </a>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"> CPM </div>
                                       
                                    </div>
                                </div>
                            </div>
                            <a href="pesq_41.php?anuf=44&estacao=CPM">
                                <div class="panel-footer">
                                    <span class="pull-left">Portas</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                      </a>
